                ...
                <div >
                    <table class="table table-striped table-success table-bordered text-center" id="sampleTable">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><img src="{{asset('storage/images_cars/'.$car->photo);}}" width="50" height="50" alt="vehicule"></td>
                            <td> {{$car->nom}} </td>
                            ...
                            <td>
                              ...
                              <div class="dropdown">
                                ...
                                <ul class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton1">
                                  ...
                                  <a  href=" {{route('cars.edit',['car'=> $car->id])}}" class=" btn btn-primary mb-1" style="width: 80%">Editer</a>

                                 <a href=" {{route('cars.show',['car'=> $car->id] )}}" class=" btn btn-info mb-1" style="width: 80%">Consulter</a>

                                  <form action="{{route('cars.destroy',['car'=> $car->id])}}" method="POST">
                                    <input type="hidden" name="_method" value="DELETE">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <button class="btn btn-danger m-1" style="width:80%;margin:auto;">Suprimer</button>
                                </form>
                                </ul>
                              </div>
                            </td>
